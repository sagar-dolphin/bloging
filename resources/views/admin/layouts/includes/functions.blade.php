...
<script>
    ...
    function confirmMultipleDelete(delId, deleteUrl, dataTable) {
        Swal.fire({
            title: 'Are you sure?',
    ...
    function confirmMultipleActive(actID, activeUrl, dataTable, status) {
        Swal.fire({
            title: 'Are you sure?',
            text: "You want to Active/Deactive these records!",
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
    ...
    function updateDisplayOrder(updateDispOrdId, dispOrder, updateDispOrdUrl, dataTable) {
        $.ajax({
            url: updateDispOrdUrl,
            type: 'POST',
            data: {
                id: updateDispOrdId,
